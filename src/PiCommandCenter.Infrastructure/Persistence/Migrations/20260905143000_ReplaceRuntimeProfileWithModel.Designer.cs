...
namespace PiCommandCenter.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260905143000_ReplaceRuntimeProfileWithModel")]
    public partial class ReplaceRuntimeProfileWithModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PiCommandCenter.Infrastructure.Mail.MailAgentIdentityRow", b =>
                {
                    ...
                    b.Property<long>("AllocatedAtUtcTicks")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("MailAgentIdentities", (string)null);
                });
            ...
            modelBuilder.Entity("PiCommandCenter.Infrastructure.Mail.MailMessageRow", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "ThreadId", "CreatedAtUtcTicks")
            ...
            modelBuilder.Entity("PiCommandCenter.Infrastructure.Mail.MailRecipientRow", b =>
                {
                    ...
                    b.Property<long?>("AcknowledgedAtUtcTicks")
                        .HasColumnType("INTEGER");

                    b.Property<long?>("ReadAtUtcTicks")
                        .HasColumnType("INTEGER");

                    b.HasKey("MessageId", "SessionId");

                    b.HasIndex("SessionId", "ReadAtUtcTicks")
            ...
            modelBuilder.Entity("PiCommandCenter.Infrastructure.Reservations.ProjectFencingTokenRow", b =>
                {
                    ...
                    b.Property<long>("LastFencingToken")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PiCommandCenter.Infrastructure.Reservations.ReservationAuditFactRow", b =>
                {
                    ...
                    b.Property<string>("RepositoryStatusSnapshot")
                        .HasMaxLength(16384)
                        .HasColumnType("TEXT");

                    b.HasKey("Id");

                    b.HasIndex("LeaseId", "AtUtcTicks")
                        .HasDatabaseName("IX_ReservationAuditFacts_LeaseId_At");

                    b.ToTable("ReservationAuditFacts", (string)null);
                });
            ...
            modelBuilder.Entity("PiCommandCenter.Infrastructure.Reservations.ReservationLeaseRow", b =>
                {
                    ...
                    b.Property<long>("AcquiredAtUtcTicks")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<long>("LastRenewedAtUtcTicks")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<long?>("ReleasedAtUtcTicks")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ProjectId", "State", "ExpiresAtUtcTicks")
                        .HasDatabaseName("IX_ReservationLeases_ProjectId_State_ExpiresAt");

                    b.ToTable("ReservationLeases", (string)null);
                });
            ...
            modelBuilder.Entity("PiCommandCenter.Infrastructure.Reservations.ReservationScopeRow", b =>
                {
                    ...
                    b.ToTable("ReservationScopes", (string)null);
                });
            ...
            modelBuilder.Entity("PiCommandCenter.Infrastructure.Mail.MailRecipientRow", b =>
                {
                    b.HasOne("PiCommandCenter.Infrastructure.Mail.MailMessageRow", "Message")
                        .WithMany("Recipients")
            ...
            modelBuilder.Entity("PiCommandCenter.Infrastructure.Reservations.ReservationScopeRow", b =>
                {
                    b.HasOne("PiCommandCenter.Infrastructure.Reservations.ReservationLeaseRow", null)
                        .WithMany("Scopes")
