...
/// <summary>Fails fast on empty or non-positive Antigravity options.</summary>
public sealed class AntigravityOptionsValidator : IValidateOptions<AntigravityOptions>
{
    public ValidateOptionsResult Validate(string? name, AntigravityOptions options)
    {
        if (!string.Equals(name, AntigravityOptions.SectionName, StringComparison.Ordinal)
